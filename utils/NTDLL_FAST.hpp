...
typedef NTSTATUS (NtSuspendThread_t)(HANDLE ThreadHandle, PULONG PreviousSuspendCount);
typedef NTSTATUS (NtResumeThread_t)(HANDLE ThreadHandle, PULONG PreviousSuspendCount);
