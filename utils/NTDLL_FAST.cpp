...
void NTDLL_INIT_FCNS(HMODULE ntdll) {
    ...
    NtSuspendThread = (NtSuspendThread_t*) GetProcAddress(ntdll, ("NtSuspendThread"));
    NtResumeThread = (NtResumeThread_t*) GetProcAddress(ntdll, ("NtResumeThread"));
}